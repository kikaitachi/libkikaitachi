...
int main(int argc, char *argv[]) {
	...
	g_test_add_func("/serialization/int/buf_len_is_0", test_kt_msg_write_int_buf_len_is_0);
	g_test_add_func("/serialization/int/positive_less_than_7_bits", test_kt_msg_write_int_positive_less_than_7_bits);
	g_test_add_func("/serialization/int/negative_less_than_7_bits", test_kt_msg_write_int_negative_less_than_7_bits);
	g_test_add_func("/serialization/int/positive_more_than_7_bits", test_kt_msg_write_int_positive_more_than_7_bits);

	g_test_add_func("/deserialization/int/positive_more_than_7_bits", test_kt_msg_read_int_positive_more_than_7_bits);
